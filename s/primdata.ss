...
(define-symbol-flags* ([libraries (rnrs) (rnrs arithmetic fixnums)] [flags primitive proc])
  ...
  (fixnum-width [sig [() -> (fixnum)]] [flags pure unrestricted cp02])
  (least-fixnum [sig [() -> (fixnum)]] [flags pure unrestricted cp02])
  (greatest-fixnum [sig [() -> (fixnum)]] [flags pure unrestricted cp02])
...
(define-symbol-flags* ([libraries (rnrs) (rnrs base)] [flags primitive proc])
  ...
  (expt [sig [(number number) -> (number)]] [flags pure discard cp02 ieee r5rs]) ; can take too long to fold
 ...
 ; c..r non-alphabetic so marks come before references
  ...
  (length [sig [(list) -> (length)]] [flags mifoldable discard ieee r5rs])
  ...
  (map [sig [(procedure list list ...) -> (list)]] [flags cp02 cp03 ieee r5rs])
  ...
  (symbol->string [sig [(symbol) -> (string)]] [flags mifoldable discard safeongoodargs ieee r5rs])
  (symbol=? [sig [(symbol symbol symbol ...) -> (boolean)]] [flags pure mifoldable discard cp03 safeongoodargs])
  (string->symbol [sig [(string) -> (symbol)]] [flags mifoldable discard safeongoodargs ieee r5rs])
  (char? [sig [(ptr) -> (boolean)]] [flags pure unrestricted mifoldable discard ieee r5rs])
  (char->integer [sig [(char) -> (fixnum)]] [flags pure mifoldable discard safeongoodargs ieee r5rs])
  (integer->char [sig [(sub-ufixnum) -> (char)]] [flags pure mifoldable discard ieee r5rs])
  ...
  (string-length [sig [(string) -> (length)]] [flags pure ieee r5rs mifoldable discard safeongoodargs])
  (string-ref [sig [(string sub-index) -> (char)]] [flags ieee r5rs mifoldable discard cp02])
  ...
  (vector-length [sig [(vector) -> (length)]] [flags pure ieee r5rs mifoldable discard safeongoodargs])
  (vector-ref [sig [(vector sub-index) -> (ptr)]] [flags ieee r5rs mifoldable discard cp02])
  (vector-set! [sig [(vector sub-index ptr) -> (void)]] [flags ieee r5rs])
  (vector->list [sig [(vector) -> (list)]] [flags alloc safeongoodargs ieee r5rs])
  (list->vector [sig [(list) -> (vector)]] [flags alloc ieee r5rs])
  (vector-fill! [sig [(vector ptr) -> (void)]] [flags ieee r5rs])
...
(define-symbol-flags* ([libraries (rnrs) (rnrs bytevectors)] [flags primitive proc])
  ...
  (bytevector-length [sig [(bytevector) -> (length)]] [flags mifoldable discard safeongoodargs])
  (bytevector=? [sig [(bytevector bytevector) -> (boolean)]] [flags mifoldable discard cp03 safeongoodargs])
  (bytevector-fill! [sig [(bytevector u8/s8) -> (void)]] [flags])
  (bytevector-copy! [sig [(bytevector sub-length bytevector sub-length sub-length) -> (void)]] [flags])
  (bytevector-copy [sig [(bytevector) -> (bytevector)]] [flags alloc safeongoodargs])
  (bytevector-u8-ref [sig [(bytevector sub-index) -> (u8)]] [flags mifoldable discard])
  (bytevector-s8-ref [sig [(bytevector sub-index) -> (s8)]] [flags mifoldable discard])
  (bytevector-u8-set! [sig [(bytevector sub-index u8) -> (void)]] [flags])
  (bytevector-s8-set! [sig [(bytevector sub-index s8) -> (void)]] [flags])
  (bytevector->u8-list [sig [(bytevector) -> (list)]] [flags alloc safeongoodargs])
  (u8-list->bytevector [sig [(sub-list) -> (bytevector)]] [flags alloc])
  (bytevector-uint-ref [sig [(bytevector sub-index symbol sub-length) -> (uint)]] [flags mifoldable discard])
  (bytevector-sint-ref [sig [(bytevector sub-index symbol sub-length) -> (sint)]] [flags mifoldable discard])
  (bytevector-uint-set! [sig [(bytevector sub-index sub-uint symbol sub-length) -> (void)]] [flags])
  (bytevector-sint-set! [sig [(bytevector sub-index sub-sint symbol sub-length) -> (void)]] [flags])
  ...
  (bytevector-u16-ref [sig [(bytevector sub-index symbol) -> (u16)]] [flags mifoldable discard])
  (bytevector-s16-ref [sig [(bytevector sub-index symbol) -> (s16)]] [flags mifoldable discard])
  (bytevector-u16-native-ref [sig [(bytevector sub-index) -> (u16)]] [flags cp02])
  (bytevector-s16-native-ref [sig [(bytevector sub-index) -> (s16)]] [flags cp02])
  (bytevector-u16-set! [sig [(bytevector sub-index u16 symbol) -> (void)]] [flags])
  (bytevector-s16-set! [sig [(bytevector sub-index s16 symbol) -> (void)]] [flags])
  (bytevector-u16-native-set! [sig [(bytevector sub-index u16) -> (void)]] [flags])
  (bytevector-s16-native-set! [sig [(bytevector sub-index s16) -> (void)]] [flags])
  (bytevector-u32-ref [sig [(bytevector sub-index symbol) -> (u32)]] [flags mifoldable discard])
  (bytevector-s32-ref [sig [(bytevector sub-index symbol) -> (s32)]] [flags mifoldable discard])
  (bytevector-u32-native-ref [sig [(bytevector sub-index) -> (u32)]] [flags cp02])
  (bytevector-s32-native-ref [sig [(bytevector sub-index) -> (s32)]] [flags cp02])
  (bytevector-u32-set! [sig [(bytevector sub-index u32 symbol) -> (void)]] [flags])
  (bytevector-s32-set! [sig [(bytevector sub-index s32 symbol) -> (void)]] [flags])
  (bytevector-u32-native-set! [sig [(bytevector sub-index u32) -> (void)]] [flags])
  (bytevector-s32-native-set! [sig [(bytevector sub-index s32) -> (void)]] [flags])
  (bytevector-u64-ref [sig [(bytevector sub-index symbol) -> (u64)]] [flags mifoldable discard])
  (bytevector-s64-ref [sig [(bytevector sub-index symbol) -> (s64)]] [flags mifoldable discard])
  (bytevector-u64-native-ref [sig [(bytevector sub-index) -> (u64)]] [flags cp02])
  (bytevector-s64-native-ref [sig [(bytevector sub-index) -> (s64)]] [flags cp02])
  (bytevector-u64-set! [sig [(bytevector sub-index u64 symbol) -> (void)]] [flags])
  (bytevector-s64-set! [sig [(bytevector sub-index s64 symbol) -> (void)]] [flags])
  (bytevector-u64-native-set! [sig [(bytevector sub-index u64) -> (void)]] [flags])
  (bytevector-s64-native-set! [sig [(bytevector sub-index s64) -> (void)]] [flags])
  (bytevector-ieee-single-ref [sig [(bytevector sub-index symbol) -> (flonum)]] [flags mifoldable discard])
  (bytevector-ieee-single-native-ref [sig [(bytevector sub-index) -> (flonum)]] [flags mifoldable discard])
  (bytevector-ieee-double-ref [sig [(bytevector sub-index symbol) -> (flonum)]] [flags mifoldable discard])
  (bytevector-ieee-double-native-ref [sig [(bytevector sub-index) -> (flonum)]] [flags mifoldable discard])
  (bytevector-ieee-single-set! [sig [(bytevector sub-index real symbol) -> (void)]] [flags])
  (bytevector-ieee-single-native-set! [sig [(bytevector sub-index real) -> (void)]] [flags])
  (bytevector-ieee-double-set! [sig [(bytevector sub-index real symbol) -> (void)]] [flags])
  (bytevector-ieee-double-native-set! [sig [(bytevector sub-index real) -> (void)]] [flags])
...
(define-symbol-flags* ([libraries (rnrs) (rnrs conditions)] [flags primitive proc])
  ...
  (simple-conditions [sig [(condition) -> (list)]] [flags mifoldable discard])
...
(define-symbol-flags* ([libraries (rnrs) (rnrs hashtables)] [flags primitive proc])
  ...
  (hashtable-size [sig [(hashtable) -> (length)]] [flags])
  (hashtable-ref [sig [(hashtable ptr ptr) -> (ptr)]] [flags discard])
  (hashtable-set! [sig [(hashtable ptr ptr) -> (void)]] [flags])
  (hashtable-delete! [sig [(hashtable ptr) -> (void)]] [flags])
  ...
  (hashtable-clear! [sig [(hashtable) (hashtable sub-uint) -> (void)]] [flags])
  ...
  (equal-hash [sig [(ptr) -> (length)]] [flags unrestricted])
  (string-hash [sig [(string) -> (length)]] [flags safeongoodargs])
  (string-ci-hash [sig [(string) -> (length)]] [flags safeongoodargs])
  (symbol-hash [sig [(symbol) -> (length)]] [flags safeongoodargs])
)
...
(define-symbol-flags* ([libraries (rnrs) (rnrs io ports) (rnrs io simple)] [flags primitive proc])
  (eof-object [sig [() -> (eof-object)]] [flags pure unrestricted mifoldable discard])
...
(define-symbol-flags* ([libraries (rnrs) (rnrs io ports)] [flags primitive proc])
  ...
  (latin-1-codec [sig [() -> (codec)]] [flags pure unrestricted])
  (utf-8-codec [sig [() -> (codec)]] [flags pure unrestricted])
  ((r6rs: utf-16-codec) [sig [() -> (codec)]] [flags pure unrestricted])
  (native-eol-style [sig [() -> (symbol)]] [flags pure unrestricted])
  ...
  (native-transcoder [sig [() -> (transcoder)]] [flags pure unrestricted])
  (transcoder-codec [sig [(transcoder) -> (codec)]] [flags pure mifoldable discard])
  (transcoder-eol-style [sig [(transcoder) -> (symbol)]] [flags pure mifoldable discard])
  (transcoder-error-handling-mode [sig [(transcoder) -> (symbol)]] [flags pure mifoldable discard])
  ...
  (open-file-input-port [sig [(pathname) (pathname file-options) (pathname file-options sub-symbol) (pathname file-options sub-symbol maybe-transcoder) -> (input-port)]] [flags])
  ...
  ((r6rs: standard-input-port) [sig [() -> (binary-input-port)]] [flags])
  ...
  (get-u8 [sig [(binary-input-port) -> (eof/u8)]] [flags])
  (lookahead-u8 [sig [(binary-input-port) -> (eof/u8)]] [flags])
  (get-bytevector-n [sig [(binary-input-port length) -> (eof/bytevector)]] [flags])
  (get-bytevector-n! [sig [(binary-input-port bytevector length length) -> (eof/length)]] [flags])
  (get-bytevector-some [sig [(binary-input-port) -> (eof/bytevector)]] [flags])
  (get-bytevector-all [sig [(binary-input-port) -> (eof/bytevector)]] [flags])
  (get-char [sig [(textual-input-port) -> (eof/char)]] [flags])
  (lookahead-char [sig [(textual-input-port) -> (eof/char)]] [flags])
  (get-string-n [sig [(textual-input-port length) -> (eof/string)]] [flags])
  (get-string-n! [sig [(textual-input-port string length length) -> (èof/length)]] [flags])
  (get-string-all [sig [(textual-input-port) -> (eof/string)]] [flags])
  (get-line [sig [(textual-input-port) -> (eof/string)]] [flags])
  (get-datum [sig [(textual-input-port) -> (ptr)]] [flags])
  ((r6rs: flush-output-port) [sig [(output-port) -> (void)]] [flags])   ; restricted to 1 argument
  (output-port-buffer-mode [sig [(output-port) -> (symbol)]] [flags])
  (open-file-output-port [sig [(pathname) (pathname file-options) (pathname file-options sub-symbol) (pathname file-options sub-symbol maybe-transcoder) -> (output-port)]] [flags])
  ...
  ((r6rs: standard-output-port) [sig [() -> (binary-output-port)]] [flags])
  ((r6rs: standard-error-port) [sig [() -> (binary-output-port)]] [flags])
  ...
  (put-bytevector [sig [(binary-output-port bytevector) (binary-output-port bytevector length) (binary-output-port bytevector length length) -> (void)]] [flags])
  (put-char [sig [(textual-output-port char) -> (void)]] [flags])
  (put-string [sig [(textual-output-port string) (textual-output-port string length) (textual-output-port string length length) -> (void)]] [flags])
  (put-datum [sig [(textual-output-port ptr) -> (void)]] [flags])
  (open-file-input/output-port [sig [(pathname) (pathname file-options) (pathname file-options sub-symbol) (pathname file-options sub-symbol maybe-transcoder) -> (input/output-port)]] [flags])
...
(define-symbol-flags* ([libraries (rnrs) (rnrs io simple)] [flags primitive proc])
  ...
  ((r6rs: open-input-file) [sig [(pathname) -> (textual-input-port)]] [flags ieee r5rs])   ; has no options argument
  ((r6rs: open-output-file) [sig [(pathname) -> (textual-output-port)]] [flags ieee r5rs])  ; has no options argument
  (close-input-port [sig [(input-port) -> (void)]] [flags ieee r5rs])
  (close-output-port [sig [(output-port) -> (void)]] [flags ieee r5rs])
  (read-char [sig [() (textual-input-port) -> (eof/char)]] [flags ieee r5rs])
  (peek-char [sig [() (textual-input-port) -> (eof/char)]] [flags ieee r5rs])
  (read [sig [() (textual-input-port) -> (ptr)]] [flags ieee r5rs])
  (write-char [sig [(char) (char textual-output-port) -> (void)]] [flags ieee r5rs])
  (newline [sig [() (textual-output-port) -> (void)]] [flags ieee r5rs])
  (display [sig [(ptr) (ptr textual-output-port) -> (void)]] [flags ieee r5rs])
  (write [sig [(ptr) (ptr textual-output-port) -> (void)]] [flags ieee r5rs])
)
...
(define-symbol-flags* ([libraries (rnrs) (rnrs lists)] [flags primitive proc])
  ...
  (filter [sig [(procedure list) -> (list)]] [flags cp03])
  ...
  (remp [sig [(procedure list) -> (list)]] [flags cp03])
...
(define-symbol-flags* ([libraries (rnrs mutable-pairs)] [flags primitive proc])
  (set-car! [sig [((ptr . ptr) ptr) -> (void)]] [flags ieee r5rs])
  (set-cdr! [sig [((ptr . ptr) ptr) -> (void)]] [flags ieee r5rs])
)

(define-symbol-flags* ([libraries (rnrs mutable-strings)] [flags primitive proc])
  (string-set! [sig [(string sub-index char) -> (void)]] [flags ieee r5rs])
  (string-fill! [sig [(string char) -> (void)]] [flags ieee r5rs])
)
...
(define-symbol-flags* ([libraries (rnrs) (rnrs records procedural)] [flags primitive proc])
  ...
  (make-record-constructor-descriptor [sig [(rtd maybe-sub-rcd maybe-procedure) -> (rcd)]] [flags pure cp02])
...
(define-symbol-flags* ([libraries (rnrs) (rnrs records inspection)] [flags primitive proc])
  ...
  (record-rtd [sig [(record) -> (rtd)]] [flags pure mifoldable discard cp02])
  (record-type-name [sig [(rtd) -> (symbol)]] [flags pure mifoldable discard cp02])
  (record-type-parent [sig [(rtd) -> (ptr)]] [flags pure mifoldable discard cp02])
  (record-type-uid [sig [(rtd) -> (symbol)]] [flags pure mifoldable discard cp02])
  ...
  (record-type-field-names [sig [(rtd) -> (vector)]] [flags pure mifoldable discard cp02])
...
(define-symbol-flags* ([libraries (rnrs) (rnrs sorting)] [flags primitive proc])
  (list-sort [sig [(procedure list) -> (list)]] [flags])
  (vector-sort [sig [(procedure vector) -> (vector)]] [flags])
  (vector-sort! [sig [(procedure vector) -> (void)]] [flags])
)
...
(define-symbol-flags* ([libraries (rnrs) (rnrs syntax-case)] [flags primitive proc])
  ...
  (datum->syntax [sig [(identifier ptr) -> (syntax)]] [flags pure mifoldable discard])
...
(define-symbol-flags* ([libraries (rnrs) (rnrs unicode)] [flags primitive proc]) ; unicode
  (char-upcase [sig [(char) -> (char)]] [flags pure mifoldable discard ieee r5rs])
  (char-downcase [sig [(char) -> (char)]] [flags pure mifoldable discard ieee r5rs])
...
(define-symbol-flags* ([libraries (chezscheme csv7)] [flags primitive proc]) ; csv7 compatibility
  ...
  ((csv7: record-type-descriptor) [sig [(record) -> (rtd)]] [flags pure mifoldable discard cp02])
  ((csv7: record-type-field-decls) [sig [(rtd) -> (list)]] [flags pure mifoldable discard cp02])
  ((csv7: record-type-field-names) [sig [(rtd) -> (list)]] [flags pure mifoldable discard cp02])
  ((csv7: record-type-name) [sig [(rtd) -> (string)]] [flags pure mifoldable discard cp02])
  ((csv7: record-type-symbol) [sig [(rtd) -> (symbol)]] [flags pure mifoldable discard cp02])
)
...
(define-symbol-flags* ([libraries] [flags primitive proc]) ; srfi 19
  ...
  (date-day [sig [(date) -> (fixnum)]] [flags pure mifoldable discard])
  (date? [sig [(ptr) -> (boolean)]] [flags pure unrestricted mifoldable discard])
  (date-hour [sig [(date) -> (fixnum)]] [flags pure mifoldable discard])
  (date-minute [sig [(date) -> (fixnum)]] [flags pure mifoldable discard])
  (date-month [sig [(date) -> (fixnum)]] [flags pure mifoldable discard])
  (date-nanosecond [sig [(date) -> (fixnum)]] [flags pure mifoldable discard])
  (date-second [sig [(date) -> (fixnum)]] [flags pure mifoldable discard])
  (date-week-day [sig [(date) -> (fixnum)]] [flags pure mifoldable discard])
  (date-year-day [sig [(date) -> (fixnum)]] [flags pure mifoldable discard])
  (date-dst? [sig [(date) -> (boolean)]] [flags pure mifoldable discard])
  (date-year [sig [(date) -> (fixnum)]] [flags pure mifoldable discard])
  (date-zone-offset [sig [(date) -> (fixnum)]] [flags pure mifoldable discard])
  ...
  (set-time-nanosecond! [sig [(time sub-uint) -> (void)]] [flags])
  (set-time-second! [sig [(time exact-integer) -> (void)]] [flags])
  (set-time-type! [sig [(time sub-symbol) -> (void)]] [flags])
  ...
  (time-difference! (sig [(time time) -> (time)]) [flags alloc])
  (time-nanosecond [sig [(time) -> (uint)]] [flags mifoldable discard])
  (time-second [sig [(time) -> (exact-integer)]] [flags mifoldable discard])
  (time-type [sig [(time) -> (symbol)]] [flags mifoldable discard])
...
(define-symbol-flags* ([libraries] [flags primitive proc]) ; constant parameters
  (directory-separator [sig [() -> (char)]] [flags pure unrestricted cp02])
  (get-initial-thread [feature pthreads] [sig [() -> (thread)]] [flags pure unrestricted])
  (get-process-id [sig [() -> (uint)]] [flags pure unrestricted])
  (get-thread-id [sig [() -> (uint)]] [flags discard unrestricted])
  (machine-type [sig [() -> (symbol)]] [flags pure unrestricted cp02])
  (most-negative-fixnum [sig [() -> (fixnum)]] [flags pure unrestricted cp02])
  (most-positive-fixnum [sig [() -> (ufixnum)]] [flags pure unrestricted cp02])
  (petite? [sig [() -> (boolean)]] [flags pure unrestricted])
  (scheme-version [sig [() -> (string)]] [flags pure unrestricted])
...
(define-symbol-flags* ([libraries] [flags primitive proc])
  ...
  (annotation-option-set [sig [(annotation) -> (annotation-options)]] [flags pure mifoldable discard])
  (annotation-source [sig [(annotation) -> (source-object)]] [flags pure mifoldable discard])
  (annotation-stripped [sig [(annotation) -> (ptr)]] [flags pure mifoldable discard])
  (append! [sig [() -> (null)] [(list ... ptr) -> (ptr)]] [flags cp02])
  (apropos [sig [(sub-ptr) (sub-ptr environment) -> (void)]] [flags])
  ...
  (binary-port-input-count [sig [(binary-input-port) -> (length)]] [flags discard])
  ...
  (binary-port-output-count [sig [(binary-output-port) -> (length)]] [flags discard])
  ...
  (block-read [sig [(textual-input-port string) (textual-input-port string length) -> (eof/length)]] [flags])
  (block-write [sig [(textual-output-port string) (textual-output-port string length) -> (void)]] [flags])
  ...
  (bytevector-truncate! [sig [(bytevector length) -> (bytevector)]] [flags])
  (bytevector->immutable-bytevector [sig [(bytevector) -> (bytevector)]] [flags alloc])
  (bytevector-s24-ref [sig [(bytevector sub-index symbol) -> (s24)]] [flags mifoldable discard])
  (bytevector-s24-set! [sig [(bytevector sub-index s24 symbol) -> (void)]] [flags])
  (bytevector-s40-ref [sig [(bytevector sub-index symbol) -> (s40)]] [flags mifoldable discard])
  (bytevector-s40-set! [sig [(bytevector sub-index s40 symbol) -> (void)]] [flags])
  (bytevector-s48-ref [sig [(bytevector sub-index symbol) -> (s48)]] [flags mifoldable discard])
  (bytevector-s48-set! [sig [(bytevector sub-index s48 symbol) -> (void)]] [flags])
  (bytevector-s56-ref [sig [(bytevector sub-index symbol) -> (s56)]] [flags mifoldable discard])
  (bytevector-s56-set! [sig [(bytevector sub-index s56 symbol) -> (void)]] [flags])
  (bytevector-u24-ref [sig [(bytevector sub-index symbol) -> (u24)]] [flags mifoldable discard])
  (bytevector-u24-set! [sig [(bytevector sub-index u24 symbol) -> (void)]] [flags])
  (bytevector-u40-ref [sig [(bytevector sub-index symbol) -> (u40)]] [flags mifoldable discard])
  (bytevector-u40-set! [sig [(bytevector sub-index u40 symbol) -> (void)]] [flags])
  (bytevector-u48-ref [sig [(bytevector sub-index symbol) -> (u48)]] [flags mifoldable discard])
  (bytevector-u48-set! [sig [(bytevector sub-index u48 symbol) -> (void)]] [flags])
  (bytevector-u56-ref [sig [(bytevector sub-index symbol) -> (u56)]] [flags mifoldable discard])
  (bytevector-u56-set! [sig [(bytevector sub-index u56 symbol) -> (void)]] [flags])
  ...
  (char>=? [sig [(char char ...) -> (boolean)]] [flags pure mifoldable discard safeongoodargs])     ; not restricted to 2+ arguments
  (char>? [sig [(char char ...) -> (boolean)]] [flags pure mifoldable discard safeongoodargs])      ; not restricted to 2+ arguments
  (char- [sig [(char char) -> (fixnum)]] [flags pure mifoldable discard safeongoodargs])
  ...
  (clear-output-port [sig [() (output-port) -> (void)]] [flags])
  (collect [sig [() (sub-ufixnum) (sub-ufixnum ptr) -> (void)]] [flags])
  ...
  (compile-file [sig [(pathname) (pathname pathname) (pathname pathname sub-symbol) -> (void)]] [flags])
  (compile-library [sig [(pathname) (pathname pathname) (pathname pathname sub-symbol) -> (void)]] [flags])
  ...
  (compile-program [sig [(pathname) (pathname pathname) (pathname pathname sub-symbol) -> (list)]] [flags])
  (compile-script [sig [(pathname) (pathname pathname) (pathname pathname sub-symbol) -> (void)]] [flags])
  ...
  (compile-to-file [sig [(list pathname) (list pathname maybe-sfd) -> (void/list)]] [flags])
  (compile-to-port [sig [(list binary-output-port) (list binary-output-port maybe-sfd) (list binary-output-port maybe-sfd maybe-binary-output-port) (list binary-output-port maybe-sfd maybe-binary-output-port sub-symbol)  (list binary-output-port maybe-sfd maybe-binary-output-port sub-symbol maybe-binary-output-port) (list binary-output-port maybe-sfd maybe-binary-output-port sub-symbol maybe-binary-output-port maybe-pathname) -> (void/list)]] [flags])
  ...
  (condition-broadcast [feature pthreads] [sig [(condition-object) -> (void)]] [flags])
  ...
  (condition-signal [feature pthreads] [sig [(condition-object) -> (void)]] [flags])
  ...
  (cost-center-allocation-count [sig [(cost-center) -> (number)]] [flags mifoldable discard])
  (cost-center-instruction-count [sig [(cost-center) -> (number)]] [flags mifoldable discard])
  (cost-center-time [sig [(cost-center) -> (time)]] [flags mifoldable discard])
  ...
  (datum->syntax-object [sig [(identifier ptr) -> (syntax)]] [flags pure mifoldable discard])
  (debug [sig [() -> (void)]] [flags])
  (debug-condition [sig [() -> (ptr)] [(ptr) -> (void)]] [flags unrestricted])
  (decode-float [sig [(flonum) -> (vector)]] [flags pure mifoldable discard])
  (default-exception-handler [sig [(ptr) -> (void)]] [flags unrestricted])
  (default-prompt-and-read [sig [(sub-integer) -> (ptr)]] [flags])
  (define-top-level-syntax [sig [(symbol ptr) (symbol ptr environment) -> (void)]] [flags])
  (define-top-level-value [sig [(symbol ptr) (symbol ptr environment) -> (void)]] [flags])
  ...
  (environment-symbols [sig [(environment) -> (list)]] [flags])
  ...
  (eq-hashtable-cell [sig [(eq-hashtable ptr ptr) -> ((ptr . ptr))]] [flags])
  (eq-hashtable-contains? [sig [(eq-hashtable ptr) -> (boolean)]] [flags discard])
  (eq-hashtable-delete! [sig [(eq-hashtable ptr) -> (void)]] [flags])
  ...
  (eq-hashtable-set! [sig [(eq-hashtable ptr ptr) -> (void)]] [flags])
  ...
  (fasl-file [sig [(pathname pathname) -> (void)]] [flags])
  (fasl-read [sig [(binary-input-port) -> (ptr)]] [flags])
  (fasl-write [sig [(sub-ptr binary-output-port) -> (void)]] [flags])
  ...
  (fl> [sig [(flonum flonum ...) -> (boolean)]] [flags pure mifoldable discard safeongoodargs])   ; not restricted to 2+ arguments
  (fl>= [sig [(flonum flonum ...) -> (boolean)]] [flags pure mifoldable discard safeongoodargs])  ; not restricted to 2+ arguments
  (flush-output-port [sig [() (output-port) -> (void)]] [flags])   ; not restricted to 1 argument
  (foreign-entry? [sig [(string) -> (boolean)]] [flags discard])
  (foreign-entry [sig [(string) -> (uptr)]] [flags discard])
  ...
  (foreign-alloc [sig [(pfixnum) -> (uint)]] [flags discard])
  (foreign-free [sig [(sub-uint) -> (void)]] [flags])
  (foreign-ref [sig [(sub-symbol uptr/iptr uptr/iptr) -> (ptr)]] [flags])
  (foreign-set! [sig [(sub-symbol uptr/iptr uptr/iptr sub-ptr) -> (void)]] [flags])
  (foreign-sizeof [sig [(sub-symbol) -> (fixnum)]] [flags pure cp02])
  (fork-thread [feature pthreads] [sig [(procedure) -> (thread)]] [flags])
  (format [sig [(sub-ptr sub-ptr ...) -> (string)]] [flags])
  (format-condition? [sig [(ptr) -> (boolean)]] [flags pure unrestricted mifoldable discard])
  (fprintf [sig [(textual-output-port string sub-ptr ...) -> (void)]] [flags])
  (fresh-line [sig [() (textual-output-port) -> (void)]] [flags])
  (ftype-pointer=? [sig [(ftype-pointer ftype-pointer) -> (boolean)]] [flags pure mifoldable discard cp03])
  (ftype-pointer-address [sig [(ftype-pointer) -> (exact-integer)]] [flags mifoldable discard])
  (ftype-pointer-ftype [sig [(ftype-pointer) -> (symbol/list)]] [flags mifoldable discard])
  ...
  (fxvector-fill! [sig [(fxvector fixnum) -> (void)]] [flags])
  (fxvector->immutable-fxvector [sig [(fxvector) -> (fxvector)]] [flags alloc safeongoodargs])
  (fxvector-length [sig [(fxvector) -> (length)]] [flags pure mifoldable discard safeongoodargs])
  (fxvector-ref [sig [(fxvector sub-index) -> (fixnum)]] [flags mifoldable discard cp02])
  (fxvector-set! [sig [(fxvector sub-index fixnum) -> (void)]] [flags])
  ...
  (gensym->unique-string [sig [(gensym) -> (string)]] [flags mifoldable]) ; can't discard ... if we have our hands on it, it must be in the oblist after this
  (get-bytevector-some! [sig [(binary-input-port bytevector length length) -> (eof/length)]] [flags])
  ...
  (get-output-string [sig [(sub-textual-output-port) -> (string)]] [flags])
  (get-registry [feature windows] [sig [(string) -> (maybe-string)]] [flags  discard])
  (get-string-some [sig [(textual-input-port) -> (eof/string)]] [flags])
  (get-string-some! [sig [(textual-input-port string length length) -> (eof/length)]] [flags])
  ...
  (hash-table-map [sig [(old-hash-table procedure) -> (list)]] [flags])
  (hashtable-cell [sig [(old-hash-table ptr ptr) -> ((ptr . ptr))]] [flags])
  ...
  (iconv-codec [feature iconv] [sig [(sub-string) -> (codec)]] [flags pure])
  ...
  (load [sig [(pathname) (pathname procedure) -> (void)]] [flags ieee r5rs])
  (load-compiled-from-port [sig [(ptr) -> (ptr ...)]] [flags])
  (load-library [sig [(pathname) (pathname procedure) -> (void)]] [flags])
  (profile-load-data [sig [(pathname) -> (void)]] [flags])
  (load-program [sig [(pathname) (pathname procedure) -> (void)]] [flags])
  (load-shared-object [sig [(maybe-pathname) -> (void)]] [flags])
  ...
  (lock-object [sig [(ptr) -> (void)]] [flags unrestricted])
  ...
  (make-annotation [sig [(ptr source-object ptr) (ptr source-object ptr annotation-options) -> (annotation)]] [flags pure mifoldable discard])
  (make-arity-wrapper-procedure [sig [(procedure sint ptr) -> (procedure)]] [flags pure mifoldable discard])
  (make-boot-file [sig [(pathname sub-list pathname ...) -> (void)]] [flags])
  (make-boot-header [sig [(pathname pathname pathname ...) -> (void)]] [flags])
  ...
  (make-parameter [sig [(ptr) (ptr procedure) -> (procedure)]] [flags cp02 cp03])
  (make-phantom-bytevector [sig [(uptr) -> (phantom-bytevector)]] [flags])
  ...
  (make-source-file-descriptor [sig [(string binary-input-port) (string binary-input-port ptr) (string binary-input-port ptr ptr) -> (sfd)]] [flags])
  (make-source-object [sig [(sfd uint uint) (sfd uint uint uint uint) -> (source-object)]] [flags pure mifoldable discard])
  (make-sstats [sig [(time time exact-integer exact-integer time time exact-integer) -> (sstats)]] [flags alloc])
  (make-thread-parameter [feature pthreads] [sig [(ptr) (ptr procedure) -> (thread-parameter)]] [flags cp02 cp03])
  (make-weak-eq-hashtable [sig [() (uint) -> (eq-hashtable)]] [flags alloc])
  (make-weak-eqv-hashtable [sig [() (uint) -> (hashtable)]] [flags alloc])
  (make-wrapper-procedure [sig [(procedure sint ptr) -> (procedure)]] [flags pure mifoldable discard])
  (mark-port-closed! [sig [(port) -> (void)]] [flags])
  (maximum-memory-bytes [sig [() -> (uint)]] [flags alloc])
  (maybe-compile-file [sig [(pathname) (pathname pathname) -> (void)]] [flags])
  (maybe-compile-library [sig [(pathname) (pathname pathname) -> (void)]] [flags])
  (maybe-compile-program [sig [(pathname) (pathname pathname) -> (void)]] [flags])
  (merge [sig [(procedure list list) -> (list)]] [flags])
  (merge! [sig [(procedure list list) -> (list)]] [flags])
  (mkdir [sig [(pathname) (pathname sub-uint) -> (void)]] [flags])
  (multibyte->string [feature windows] [sig [(sub-uint bytevector) -> (string)]] [flags discard])
  ...
  (mutex-release [feature pthreads] [sig [(mutex) -> (void)]] [flags])
  ...
  (open-fd-input-port [sig [(sub-ufixnum) (sub-ufixnum sub-symbol) (sub-ufixnum sub-symbol maybe-transcoder) -> (input-port)]] [flags])
  (open-fd-input/output-port [sig [(sub-ufixnum) (sub-ufixnum sub-symbol) (sub-ufixnum sub-symbol maybe-transcoder) -> (input/output-port)]] [flags])
  (open-fd-output-port [sig [(sub-ufixnum) (sub-ufixnum sub-symbol) (sub-ufixnum sub-symbol maybe-transcoder) -> (output-port)]] [flags])
  (open-input-file [sig [(pathname) (pathname sub-ptr) -> (textual-input-port)]] [flags])    ; has options argument
  (open-input-output-file [sig [(pathname) (pathname sub-ptr) -> (textual-input/output-port)]] [flags])
  (open-input-string [sig [(string) -> (textual-input-port)]] [flags alloc])
  (open-output-file [sig [(pathname) (pathname sub-ptr) -> (textual-output-port)]] [flags])   ; has options argument
  ...
  (path-extension [sig [(pathname) -> (pathname)]] [flags #;cp02])   ; it's probably not worth the effort
  (path-first [sig [(pathname) -> (pathname)]] [flags #;cp02])
  (path-last [sig [(pathname) -> (pathname)]] [flags #;cp02])
  (path-parent [sig [(pathname) -> (pathname)]] [flags #;cp02])
  (path-rest [sig [(pathname) -> (pathname)]] [flags #;cp02])
  (path-root [sig [(pathname) -> (pathname)]] [flags #;cp02])
  (phantom-bytevector? [sig [(ptr) -> (boolean)]] [flags pure unrestricted mifoldable discard])
  (phantom-bytevector-length [sig [(phantom-bytevector) -> (uptr)]] [flags])
  ...
  (port-input-buffer [sig [(port) -> (string/bytevector)]] [flags discard])
  (port-input-count [sig [(port) -> (ufixnum)]] [flags discard])
  (port-input-empty? [sig [(input-port) -> (boolean)]] [flags discard])
  (port-input-index [sig [(port) -> (ufixnum)]] [flags discard])
  (port-input-size [sig [(port) -> (ufixnum)]] [flags discard])
  ...
  (port-output-buffer [sig [(port) -> (string/bytevector)]] [flags discard])
  (port-output-count [sig [(port) -> (ufixnum)]] [flags discard])
  (port-output-full? [sig [(output-port) -> (boolean)]] [flags discard])
  (port-output-index [sig [(port) -> (ufixnum)]] [flags discard])
  (port-output-size [sig [(port) -> (ufixnum)]] [flags discard])
  (pretty-file [sig [(pathname pathname) -> (void)]] [flags])
  (pretty-format [sig [(symbol) -> (ptr)] [(symbol sub-ptr) -> (void)]] [flags])
  (pretty-print [sig [(ptr) (ptr textual-output-port) -> (void)]] [flags])
  (printf [sig [(string sub-ptr ...) -> (void)]] [flags])
  (procedure-arity-mask [sig [(procedure) -> (sint)]] [flags mifoldable discard safeongoodargs])
  (procedure-known-single-valued? [sig [(procedure) -> (boolean)]] [flags mifoldable discard safeongoodargs])
  (process [sig [(string) -> (list)]] [flags])
  (profile-clear-database [sig [() -> (void)]] [flags])
  (profile-clear [sig [() -> (void)]] [flags])
  (profile-dump [sig [() -> (list)]] [flags discard])
  (profile-dump-data [sig [(pathname) (pathname sub-list) -> (void)]] [flags])
  (profile-dump-list [sig [() (ptr) (ptr sub-list) -> (list)]] [flags discard])
  (profile-dump-html [sig [() (pathname) (pathname sub-list) -> (void)]] [flags])
  (profile-release-counters [sig [() -> (void)]] [flags])
  (property-list [sig [(symbol) -> (list)]] [flags discard safeongoodargs])
  (put-bytevector-some [sig [(binary-output-port bytevector) (binary-output-port bytevector length) (binary-output-port bytevector length length) -> (uint)]] [flags])
  (put-hash-table! [sig [(old-hash-table ptr ptr) -> (void)]] [flags])
  (put-registry! [feature windows] [sig [(string string) -> (void)]] [flags])
  (put-string-some [sig [(textual-output-port string) (textual-output-port string length) (textual-output-port string length length) -> (uint)]] [flags])
  (putprop [sig [(symbol ptr ptr) -> (void)]] [flags safeongoodargs])
  (putenv [sig [(string string) -> (void)]] [flags])
  ...
  (remove-hash-table! [sig [(old-hash-table ptr) -> (void)]] [flags])
  (remove-registry! [feature windows] [sig [(string) -> (void)]] [flags])
  (remove! [sig [(ptr list) -> (list)]] [flags])
  (remprop [sig [(symbol ptr) -> (void)]] [flags safeongoodargs])
  (remq! [sig [(ptr list) -> (list)]] [flags])
  (remv! [sig [(ptr list) -> (list)]] [flags])
  (rename-file [sig [(pathname ptr) -> (void)]] [flags])
  (reset [sig [() -> (bottom)]] [flags abort-op])
  (reset-cost-center! [sig [(cost-center) -> (void)]] [flags])
  (reset-maximum-memory-bytes! [sig [() -> (void)]] [flags])
  (reverse! [sig [(list) -> (list)]] [flags])
  (revisit [sig [(pathname) -> (void)]] [flags])
  ...
  (set-binary-port-input-buffer! [sig [(binary-input-port bytevector) -> (void)]] [flags])
  (set-binary-port-input-index! [sig [(binary-input-port sub-index) -> (void)]] [flags])
  (set-binary-port-input-size! [sig [(binary-input-port sub-length) -> (void)]] [flags])
  (set-binary-port-output-buffer! [sig [(binary-output-port bytevector) -> (void)]] [flags])
  (set-binary-port-output-index! [sig [(binary-output-port sub-index) -> (void)]] [flags])
  (set-binary-port-output-size! [sig [(binary-output-port sub-length) -> (void)]] [flags])
  (set-box! [sig [(box ptr) -> (void)]] [flags])
  (set-phantom-bytevector-length! [sig [(phantom-bytevector uptr) -> (void)]] [flags])
  (set-port-bol! [sig [(textual-output-port ptr) -> (void)]] [flags])
  (set-port-eof! [sig [(input-port ptr) -> (void)]] [flags])
  (set-port-input-buffer! [sig [(input-port string/bytevector) -> (void)]] [flags])
  (set-port-input-index! [sig [(input-port sub-index) -> (void)]] [flags])
  (set-port-input-size! [sig [(input-port sub-length) -> (void)]] [flags])
  ...
  (set-port-output-buffer! [sig [(output-port string/bytevector) -> (void)]] [flags])
  (set-port-output-index! [sig [(output-port sub-index) -> (void)]] [flags])
  (set-port-output-size! [sig [(output-port sub-length) -> (void)]] [flags])
  (set-sstats-bytes! [sig [(sstats exact-integer) -> (void)]] [flags])
  (set-sstats-cpu! [sig [(sstats time) -> (void)]] [flags])
  (set-sstats-gc-bytes! [sig [(sstats exact-integer) -> (void)]] [flags])
  (set-sstats-gc-count! [sig [(sstats exact-integer) -> (void)]] [flags])
  (set-sstats-gc-cpu! [sig [(sstats time) -> (void)]] [flags])
  (set-sstats-gc-real! [sig [(sstats time) -> (void)]] [flags])
  (set-sstats-real! [sig [(sstats time) -> (void)]] [flags])
  (set-textual-port-input-buffer! [sig [(textual-input-port string) -> (void)]] [flags])
  (set-textual-port-input-index! [sig [(textual-input-port sub-index) -> (void)]] [flags])
  (set-textual-port-input-size! [sig [(textual-input-port sub-length) -> (void)]] [flags])
  (set-textual-port-output-buffer! [sig [(textual-output-port string) -> (void)]] [flags])
  (set-textual-port-output-index! [sig [(textual-output-port sub-index) -> (void)]] [flags])
  (set-textual-port-output-size! [sig [(textual-output-port sub-length) -> (void)]] [flags])
  (set-timer [sig [(ufixnum) -> (ufixnum)]] [flags])
  (set-top-level-value! [sig [(symbol ptr) (symbol ptr environment) -> (void)]] [flags])
  (set-virtual-register! [sig [(sub-index ptr) -> (void)]] [flags])
  (set-wrapper-procedure! [sig [(ptr procedure) -> (void)]] [flags])
  (set-wrapper-procedure-data! [sig [(ptr ptr) -> (void)]] [flags])
  (sinh [sig [(number) -> (number)]] [flags arith-op mifoldable discard])
  (sleep [sig [(time) -> (void)]] [flags])
  (sort [sig [(procedure list) -> (list)]] [flags])
  (sort! [sig [(procedure list) -> (list)]] [flags])
  ...
  (source-file-descriptor-checksum [sig [(sfd) -> (sint)]] [flags pure mifoldable discard])
  (source-file-descriptor-path [sig [(sfd) -> (string)]] [flags pure mifoldable discard])
  ...
  (sstats-difference [sig [(sstats sstats) -> (sstats)]] [flags mifoldable discard])
  ...
  (sstats-print [sig [(sstats) (sstats textual-output-port) -> (void)]] [flags])
  (sstats-real [sig [(sstats) -> (time)]] [flags mifoldable discard])
  (sstats? [sig [(ptr) -> (boolean)]] [flags pure unrestricted mifoldable discard])
  (standard-input-port [sig [() (sub-symbol) (sub-symbol maybe-transcoder) -> (input-port)]] [flags])
  (standard-output-port [sig [() (sub-symbol) (sub-symbol maybe-transcoder) -> (output-port)]] [flags])
  (standard-error-port [sig [() (sub-symbol) (sub-symbol maybe-transcoder) -> (output-port)]] [flags])
  (statistics [sig [() -> (sstats)]] [flags unrestricted alloc])
  (string->multibyte [feature windows] [sig [(sub-uint string) -> (bytevector)]] [flags discard])
  ...
  (string-ci>=? [sig [(string string ...) -> (boolean)]] [flags mifoldable discard safeongoodargs ieee r5rs])  ; not restricted to 2+ arguments
  (string-ci>? [sig [(string string ...) -> (boolean)]] [flags mifoldable discard safeongoodargs ieee r5rs])   ; not restricted to 2+ arguments
  (string-copy! [sig [(string sub-length string sub-length sub-length) -> (void)]] [flags])
  (string->immutable-string [sig [(string) -> (string)]] [flags alloc safeongoodargs])
  (string-truncate! [sig [(string length) -> (string)]] [flags])
  (strip-fasl-file [sig [(pathname pathname fasl-strip-options) -> (void)]] [flags])
  ...
  (substring-fill! [sig [(string sub-length sub-length char) -> (void)]] [flags])
  ...
  (symbol-hashtable-cell [sig [(symbol-hashtable ptr ptr) -> ((ptr . ptr))]] [flags])
  (symbol-hashtable-contains? [sig [(symbol-hashtable ptr) -> (boolean)]] [flags discard])
  (symbol-hashtable-delete! [sig [(symbol-hashtable ptr) -> (void)]] [flags])
  (symbol-hashtable-ref [sig [(symbol-hashtable symbol ptr) -> (ptr)]] [flags discard])
  (symbol-hashtable-set! [sig [(symbol-hashtable symbol ptr) -> (void)]] [flags])
  ...
  (textual-port-input-count [sig [(textual-input-port) -> (length)]] [flags discard])
  ...
  (textual-port-output-count [sig [(textual-output-port) -> (length)]] [flags discard])
  ...
  (transcript-off [sig [() -> (void)]] [flags ieee r5rs])
  (transcript-on [sig [(pathname) -> (void)]] [flags ieee r5rs])
  ...
  (unget-u8 [sig [(binary-input-port eof/u8) -> (void)]] [flags])
  (unget-char [sig [(textual-input-port eof/char) -> (void)]] [flags])
  (unlock-object [sig [(ptr) -> (void)]] [flags unrestricted])
  (unread-char [sig [(char) (char textual-input-port) -> (void)]] [flags])
  (utf-16-codec [sig [() -> (codec)] [(sub-symbol) -> (codec)]] [flags pure]) ; has optional eness argument
  (utf-16le-codec [sig [() -> (codec)]] [flags pure unrestricted])
  (utf-16be-codec [sig [() -> (codec)]] [flags pure unrestricted])
  ...
  (vector-set-fixnum! [sig [(vector sub-index fixnum) -> (void)]] [flags])
  (virtual-register [sig [(sub-index) -> (ptr)]] [flags discard])
  (virtual-register-count [sig [() -> (length)]] [flags pure unrestricted cp02])
  (visit [sig [(pathname) -> (void)]] [flags])
  (void [sig [() -> (void)]] [flags pure unrestricted mifoldable discard])
