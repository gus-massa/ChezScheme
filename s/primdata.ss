...
(define-symbol-flags* ([libraries (rnrs) (rnrs base)] [flags primitive proc])
 ...
 ; c..r non-alphabetic so marks come before references
  ...
  (vector-map [sig [(procedure vector vector ...) -> (vector)]] [flags true cp03])
...
(define-symbol-flags* ([libraries (rnrs eval)] [flags primitive proc])
  ...
  (environment [sig [(import-spec ...) -> (environment)]] [flags true])
)
...
(define-symbol-flags* ([libraries (rnrs) (rnrs files)] [flags primitive proc])
  ...
  ((r6rs: delete-file) [sig [(pathname) -> (void)]] [flags true])         ; restricted to 1 argument
)
...
(define-symbol-flags* ([libraries (rnrs) (rnrs hashtables)] [flags primitive proc])
  ...
  (hashtable-update! [sig [(hashtable ptr procedure ptr) -> (void)]] [flags true])
...
(define-symbol-flags* ([libraries (rnrs) (rnrs io ports) (rnrs io simple)] [flags primitive proc])
  ...
  ((r6rs: current-input-port) [sig [() -> (textual-input-port)]] [flags ieee r5rs true])
  (output-port? [sig [(ptr) -> (boolean)]] [flags pure unrestricted mifoldable discard ieee r5rs])
  ((r6rs: current-output-port) [sig [() -> (textual-output-port)]] [flags ieee r5rs true])
  ((r6rs: current-error-port) [sig [() -> (textual-output-port)]] [flags true])
)
...
(define-symbol-flags* ([libraries (rnrs) (rnrs io ports)] [flags primitive proc])
  ...
  (set-port-position! [sig [(port sub-ptr) -> (void)]] [flags true])
  ...
  ((r6rs: flush-output-port) [sig [(output-port) -> (void)]] [flags true])   ; restricted to 1 argument
  ...
  (call-with-bytevector-output-port [sig [(procedure) (procedure maybe-transcoder) -> (bytevector)]] [flags true])
  (open-string-output-port [sig [() -> (textual-output-port procedure)]] [flags discard])
  (call-with-string-output-port [sig [(procedure) -> (string)]] [flags true])
  ...
  (put-u8 [sig [(binary-output-port u8) -> (void)]] [flags true])
...
(define-symbol-flags* ([libraries (rnrs) (rnrs programs)] [flags primitive proc])
  ((r6rs: command-line) [sig [() -> (list)]] [flags true])  ; restricted to 0 arguments
...
(define-symbol-flags* ([libraries (rnrs) (rnrs records procedural)] [flags primitive proc])
  ...
  ((r6rs: record-constructor) [sig [(rcd) -> (procedure)]] [flags cp02 true]) ; user-supplied protocol can do anything
...
(define-symbol-flags* ([libraries (rnrs) (rnrs unicode)] [flags primitive proc]) ; unicode
  ...
  (char-titlecase [sig [(char) -> (char)]] [flags pure mifoldable discard true])
  (char-foldcase [sig [(char) -> (char)]] [flags pure mifoldable discard true])
  ...
  (char-general-category [sig [(char) -> (symbol)]] [flags pure mifoldable discard true])
  (string-upcase [sig [(string) -> (string)]] [flags mifoldable discard true])
  (string-downcase [sig [(string) -> (string)]] [flags mifoldable discard true])
  (string-titlecase [sig [(string) -> (string)]] [flags mifoldable discard true])
  (string-foldcase [sig [(string) -> (string)]] [flags mifoldable discard true])
  ...
  ((r6rs: string-ci>=?) [sig [(string string string ...) -> (boolean)]] [flags mifoldable discard ieee r5rs])  ; restricted to 2+ arguments
  ((r6rs: string-ci>?) [sig [(string string string ...) -> (boolean)]] [flags mifoldable discard ieee r5rs])   ; restricted to 2+ arguments
  (string-normalize-nfd [sig [(string) -> (string)]] [flags mifoldable discard true])
  (string-normalize-nfkd [sig [(string) -> (string)]] [flags mifoldable discard true])
  (string-normalize-nfc [sig [(string) -> (string)]] [flags mifoldable discard true])
  (string-normalize-nfkc [sig [(string) -> (string)]] [flags mifoldable discard true])
)
...
(define-symbol-flags* ([libraries] [flags primitive proc]) ; constant parameters
  ...
  (get-process-id [sig [() -> (uint)]] [flags pure unrestricted true])
  (get-thread-id [sig [() -> (uint)]] [flags discard unrestricted true])
...
(define-symbol-flags* ([libraries] [flags primitive proc]) ; variable parameters
  (abort-handler [sig [() -> (procedure)] [(procedure) -> (void)]] [flags true])
  (base-exception-handler [sig [() -> (procedure)] [(procedure) -> (void)]] [flags true])
  (break-handler [sig [() -> (procedure)] [(procedure) -> (void)]] [flags true])
  (case-sensitive [sig [() -> (boolean)] [(ptr) -> (void)]] [flags unrestricted])
  (cd [sig [() -> (pathname)] [(pathname) -> (void)]] [flags true])
  (collect-generation-radix [sig [() -> (ufixnum)] [(sub-ufixnum) -> (void)]] [flags true])
  (collect-maximum-generation [sig [() -> (ufixnum)] [(sub-ufixnum) -> (void)]] [flags true])
  (collect-notify [sig [() -> (boolean)] [(ptr) -> (void)]] [flags unrestricted])
  (collect-request-handler [sig [() -> (procedure)] [(procedure) -> (void)]] [flags true])
  (collect-trip-bytes [sig [() -> (ufixnum)] [(ufixnum) -> (void)]] [flags true])
  (command-line [sig [() -> (list)] [(sub-list) -> (void)]] [flags true])  ; not restricted to 1 argument
  (command-line-arguments [sig [() -> (list)] [(sub-list) -> (void)]] [flags true])
  (commonization-level [sig [() -> (ufixnum)] [(sub-ufixnum) -> (void)]] [flags true])
  ...
  (compile-library-handler [sig [() -> (procedure)] [(procedure) -> (void)]] [flags true])
  (compile-profile [sig [() -> (ptr)] [(ptr) -> (void)]] [flags unrestricted])
  (compile-program-handler [sig [() -> (procedure)] [(procedure) -> (void)]] [flags true])
  (compress-format [sig [() -> (symbol)] [(sub-symbol) -> (void)]] [flags true])
  (compress-level [sig [() -> (symbol)] [(sub-symbol) -> (void)]] [flags true])
  (console-error-port [sig [() -> (textual-output-port)] [(textual-output-port) -> (void)]] [flags true])
  (console-input-port [sig [() -> (textual-input-port)] [(textual-input-port) -> (void)]] [flags true])
  (console-output-port [sig [() -> (textual-output-port)] [(textual-output-port) -> (void)]] [flags true])
  (cp0-effort-limit [sig [() -> (ufixnum)] [(ufixnum) -> (void)]] [flags true])
  (cp0-outer-unroll-limit [sig [() -> (ufixnum)] [(ufixnum) -> (void)]] [flags true])
  (cp0-score-limit [sig [() -> (ufixnum)] [(ufixnum) -> (void)]] [flags true])
  (current-directory [sig [() -> (pathname)] [(pathname) -> (void)]] [flags true])
  (current-error-port [sig [() -> (textual-output-port)] [(textual-output-port) -> (void)]] [flags true])  ; not restricted to 1 argument
  (current-eval [sig [() -> (procedure)] [(procedure) -> (void)]] [flags true])
  (current-exception-state [sig [() -> (exception-state)] [(exception-state) -> (void)]] [flags true])
  (current-expand [sig [() -> (procedure)] [(procedure) -> (void)]] [flags true])
  (current-generate-id [sig [() -> (procedure)] [(procedure) -> (void)]] [flags true])
  (current-input-port [sig [() -> (textual-input-port)] [(textual-input-port) -> (void)]] [flags true])    ; not restricted to 1 argument
  (current-locate-source-object-source [sig [() -> (procedure)] [(procedure) -> (void)]] [flags true])
  (current-make-source-object [sig [() -> (procedure)] [(procedure) -> (void)]] [flags true])
  (current-output-port [sig [() -> (textual-output-port)] [(textual-output-port) -> (void)]] [flags true]) ; not restricted to 1 argument
  (current-transcoder [sig [() -> (transcoder)] [(transcoder) -> (void)]] [flags true])
  (custom-port-buffer-size [sig [() -> (ufixnum)] [(sub-fixnum) -> (void)]] [flags true])
  (debug-level [sig [() -> (ufixnum)] [(sub-ufixnum) -> (void)]] [flags true])
  ...
  (eval-syntax-expanders-when [sig [() -> (list)] [(sub-list) -> (void)]] [flags true])
  ...
  (exit-handler [sig [() -> (procedure)] [(procedure) -> (void)]] [flags true])
  (file-buffer-size [sig [() -> (ufixnum)] [(sub-fixnum) -> (void)]] [flags true])
  ...
  (gensym-count [sig [() -> (uint)] [(uint) -> (void)]] [flags true])
  (gensym-prefix [sig [() -> (ptr)] [(ptr) -> (void)]] [flags unrestricted])
  (heap-reserve-ratio [sig [() -> (number)] [(sub-number) -> (void)]] [flags true])
  (import-notify [sig [() -> (boolean)] [(ptr) -> (void)]] [flags unrestricted])
  (interaction-environment [sig [() -> (environment)] [(environment) -> (void)]] [flags true ieee r5rs])
  (internal-defines-as-letrec* [sig [() -> (boolean)] [(ptr) -> (void)]] [flags unrestricted])
  (keyboard-interrupt-handler [sig [() -> (procedure)] [(procedure) -> (void)]] [flags true])
  (library-directories [sig [() -> (list)] [(sub-ptr) -> (void)]] [flags true])
  (library-exports [sig [(sub-list) -> (list)]] [flags true])
  (library-extensions [sig [() -> (list)] [(sub-ptr) -> (void)]] [flags true])
  (library-object-filename [sig [(sub-list) -> (maybe-string)]] [flags])
  (library-list [sig [() -> (list)]] [flags true])
  (library-requirements [sig [(sub-list) -> (list)] [(sub-list library-requirements-options) -> (list)]] [flags true])
  (library-search-handler [sig [() -> (procedure)] [(procedure) -> (void)]] [flags true])
  (library-version [sig [(sub-list) -> (list)]] [flags true])
  (optimize-level [sig [() -> (ufixnum)] [(sub-ufixnum) -> (void)]] [flags true])
  (pretty-initial-indent [sig [() -> (ufixnum)] [(ufixnum) -> (void)]] [flags true])
  (pretty-line-length [sig [() -> (ufixnum)] [(sub-ufixnum) -> (void)]] [flags true])
  (pretty-maximum-lines [sig [() -> (maybe-ufixnum)] [(maybe-ufixnum) -> (void)]] [flags])
  (pretty-one-line-limit [sig [() -> (ufixnum)] [(sub-ufixnum) -> (void)]] [flags true])
  (pretty-standard-indent [sig [() -> (ufixnum)] [(ufixnum) -> (void)]] [flags true])
  ...
  (print-radix [sig [() -> (ufixnum)] [(sub-ufixnum) -> (void)]] [flags true])
  ...
  (profile-palette [sig [() -> (vector)] [(sub-vector) -> (void)]] [flags true])
  (profile-line-number-color [sig [() -> (maybe-string)] [(maybe-string) -> (void)]] [flags])
  (random-seed [sig [() -> (u32)] [(u32) -> (void)]] [flags true])
  (release-minimum-generation [sig [() -> (ufixnum)] [(sub-ufixnum) -> (void)]] [flags true])
  (require-nongenerative-clause [sig [() -> (boolean)] [(ptr) -> (void)]] [flags unrestricted])
  (reset-handler [sig [() -> (procedure)] [(procedure) -> (void)]] [flags true])
  (run-cp0 [sig [() -> (procedure)] [(procedure) -> (void)]] [flags true])
  (scheme-start [sig [() -> (procedure)] [(procedure) -> (void)]] [flags true])
  (scheme-program [sig [() -> (procedure)] [(procedure) -> (void)]] [flags true])
  (scheme-script [sig [() -> (procedure)] [(procedure) -> (void)]] [flags true])
  (source-directories [sig [() -> (list)] [(sub-list) -> (void)]] [flags true])
  (subset-mode [sig [() -> (maybe-symbol)] [(maybe-sub-symbol) -> (void)]] [flags])
  (suppress-greeting [sig [() -> (boolean)] [(ptr) -> (void)]] [flags unrestricted])
  (timer-interrupt-handler [sig [() -> (procedure)] [(procedure) -> (void)]] [flags true])
  (trace-output-port [sig [() -> (maybe-textual-output-port)] [(maybe-textual-output-port) -> (void)]] [flags])
  (trace-print [sig [() -> (procedure)] [(procedure) -> (void)]] [flags true])
  (undefined-variable-warnings [sig [() -> (boolean)] [(ptr) -> (void)]] [flags unrestricted])
  (waiter-prompt-string [sig [() -> (string)] [(string) -> (void)]] [flags true])
  (waiter-prompt-and-read [sig [() -> (procedure)] [(procedure) -> (void)]] [flags true])
  (waiter-write [sig [() -> (procedure)] [(procedure) -> (void)]] [flags true])
)
...
(define-symbol-flags* ([libraries] [flags primitive proc])
  ...
  (binary-port-input-buffer [sig [(binary-input-port) -> (bytevector)]] [flags discard true])
  (binary-port-input-count [sig [(binary-input-port) -> (length)]] [flags discard true])
  (binary-port-input-index [sig [(binary-input-port) -> (index)]] [flags discard true])
  (binary-port-input-size [sig [(binary-input-port) -> (length)]] [flags discard true])
  (binary-port-output-buffer [sig [(binary-output-port) -> (bytevector)]] [flags discard true])
  (binary-port-output-count [sig [(binary-output-port) -> (length)]] [flags discard true])
  (binary-port-output-index [sig [(binary-output-port) -> (index)]] [flags discard true])
  (binary-port-output-size [sig [(binary-output-port) -> (length)]] [flags discard true])
  ...
  (chmod [sig [(pathname sub-ufixnum) -> (void)]] [flags true])
  ...
  (collect-rendezvous [sig [() -> (void)]] [flags true])
  ...
  (compile-whole-program [sig [(string string) (string string ptr) -> (void)]] [flags true])
  (compile-whole-library [sig [(string string) -> (void)]] [flags true])
  ...
  (continuation-next-attachments [sig [(ptr) -> (list)]] [flags true])
  ...
  (display-condition [sig [(ptr) (ptr textual-output-port) -> (void)]] [flags true])
  ...
  (eq-hashtable-update! [sig [(eq-hashtable ptr procedure ptr) -> (void)]] [flags true])
  ...
  (vfasl-convert-file [sig [(ptr ptr ptr) -> (void)]] [flags true])
  (file-access-time [sig [(pathname) (pathname ptr) -> (time)]] [flags discard true])
  (file-change-time [sig [(pathname) (pathname ptr) -> (time)]] [flags discard true])
  ...
  (file-length [sig [(sub-port) -> (uint)]] [flags true])
  (file-modification-time [sig [(pathname) (pathname ptr) -> (time)]] [flags discard true])
  (file-position [sig [(sub-port) -> (sub-ptr)] [(sub-port sub-ptr) -> (void)]] [flags])
  (file-port? [sig [(port) -> (boolean)]] [flags pure mifoldable discard])
  (port-file-compressed! [sig [(port) -> (void)]] [flags true])
  ...
  (foreign-callable-entry-point [sig [(code) -> (uint)]] [flags discard true])
  (foreign-callable-code-object [sig [(sint) -> (code)]] [flags discard true])
  ...
  (format [sig [(sub-ptr sub-ptr ...) -> (string)]] [flags true])
  ...
  (fxvector-ref [sig [(fxvector sub-index) -> (fixnum)]] [flags mifoldable discard true cp02])
  ...
  (get-mode [sig [(pathname) (pathname ptr) -> (fixnum)]] [flags true])
  ...
  (hash-table-for-each [sig [(old-hash-table procedure) -> (void)]] [flags true])
  ...
  (inspect [sig [(ptr) -> (void)]] [flags unrestricted true])
  (inspect/object [sig [(ptr) -> (procedure)]] [flags unrestricted true])
  ...
  (last-pair [sig [(pair) -> ((ptr . ptr))]] [flags mifoldable discard true])
  ...
  (make-continuation-condition [sig [(ptr) -> (condition)]] [flags pure unrestricted mifoldable discard true])
  ...
  (make-format-condition [sig [() -> (condition)]] [flags pure unrestricted mifoldable discard true])
  ...
  (make-source-condition [sig [(ptr) -> (condition)]] [flags pure unrestricted mifoldable discard true])
  ...
  (merge! [sig [(procedure list list) -> (list)]] [flags true])
  (mkdir [sig [(pathname) (pathname sub-uint) -> (void)]] [flags true])
  ...
  (port-file-descriptor [sig [(port) -> (ufixnum)]] [flags discard true])
  (port-handler [sig [(port) -> (procedure)]] [flags discard true])
  ...
  (port-length [sig [(port) -> (uint)]] [flags true])
  ...
  (process [sig [(string) -> (list)]] [flags true])
  ...
  (record-constructor [sig [(sub-ptr) -> (procedure)]] [flags cp02 true]) ; accepts rtd or rcd
  ...
  (register-signal-handler [sig [(sint procedure) -> (void)]] [flags true])
  ...
  (remprop [sig [(symbol ptr) -> (void)]] [flags true safeongoodargs])
  (remq! [sig [(ptr list) -> (list)]] [flags true])
  (remv! [sig [(ptr list) -> (list)]] [flags true])
  (rename-file [sig [(pathname ptr) -> (void)]] [flags true])
  ...
  (set-port-length! [sig [(sub-port uint) -> (void)]] [flags true])
  (set-port-name! [sig [(port ptr) -> (void)]] [flags true])
  (set-port-nonblocking! [sig [(port ptr) -> (void)]] [flags true])
  ...
  (source-object-bfp [sig [(source-object) -> (uint)]] [flags pure mifoldable discard true])
  (source-object-column [sig [(source-object) -> (maybe-uint)]] [flags pure mifoldable discard])
  (source-object-efp [sig [(source-object) -> (uint)]] [flags pure mifoldable discard true])
  (source-object-line [sig [(source-object) -> (maybe-uint)]] [flags pure mifoldable discard])
  (source-object-sfd [sig [(source-object) -> (sfd)]] [flags pure mifoldable discard true])
  (sstats-bytes [sig [(sstats) -> (exact-integer)]] [flags mifoldable discard true])
  (sstats-cpu [sig [(sstats) -> (time)]] [flags mifoldable discard true])
  (sstats-difference [sig [(sstats sstats) -> (sstats)]] [flags mifoldable discard true])
  (sstats-gc-bytes [sig [(sstats) -> (exact-integer)]] [flags mifoldable discard true])
  (sstats-gc-count [sig [(sstats) -> (exact-integer)]] [flags mifoldable discard true])
  (sstats-gc-cpu [sig [(sstats) -> (time)]] [flags mifoldable discard true])
  (sstats-gc-real [sig [(sstats) -> (time)]] [flags mifoldable discard true])
  (sstats-print [sig [(sstats) (sstats textual-output-port) -> (void)]] [flags true])
  (sstats-real [sig [(sstats) -> (time)]] [flags mifoldable discard true])
  ...
  (symbol-hashtable-update! [sig [(symbol-hashtable symbol procedure ptr) -> (void)]] [flags true])
  ...
  (textual-port-input-buffer [sig [(textual-input-port) -> (string)]] [flags discard true])
  (textual-port-input-count [sig [(textual-input-port) -> (length)]] [flags discard true])
  (textual-port-input-index [sig [(textual-input-port) -> (index)]] [flags discard true])
  (textual-port-input-size [sig [(textual-input-port) -> (length)]] [flags discard true])
  (textual-port-output-buffer [sig [(textual-output-port) -> (string)]] [flags discard true])
  (textual-port-output-count [sig [(textual-output-port) -> (length)]] [flags discard true])
  (textual-port-output-index [sig [(textual-output-port) -> (index)]] [flags discard true])
  (textual-port-output-size [sig [(textual-output-port) -> (length)]] [flags discard true])
  ...
  (truncate-file [sig [(output-port) (output-port sub-ptr) -> (void)]] [flags true])
  (truncate-port [sig [(output-port) (output-port sub-ptr) -> (void)]] [flags true])
  ...
  (with-output-to-string [sig [(procedure) -> (string)]] [flags true])
