...
(define-symbol-flags* ([libraries (rnrs) (rnrs arithmetic fixnums)] [flags primitive proc])
  ...
  (fx+/carry [sig [(fixnum fixnum fixnum) -> (fixnum fixnum)]] [flags pure cp02])
  (fx-/carry [sig [(fixnum fixnum fixnum) -> (fixnum fixnum)]] [flags pure cp02])
  (fx*/carry [sig [(fixnum fixnum fixnum) -> (fixnum fixnum)]] [flags pure cp02])
...
(define-symbol-flags* ([libraries (rnrs) (rnrs base)] [flags primitive proc])
  ...
  (exact-integer-sqrt [sig [(integer) -> (integer integer)]] [flags pure cp02]) ; could be mifoldable if multiple values were handled
...
(define-symbol-flags* ([libraries] [flags primitive proc]) ; constant parameters
  ...
  (scheme-version-number [sig [() -> (uint uint uint)]] [flags pure unrestricted])
