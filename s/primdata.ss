...
(define-symbol-flags* ([libraries] [flags system proc]) ; system procedures
  ...
  ($integer-16? [sig [(ptr) -> (boolean)]] [flags single-valued pure unrestricted mifoldable discard])
  ($integer-24? [sig [(ptr) -> (boolean)]] [flags single-valued pure unrestricted mifoldable discard])
  ($integer-32? [sig [(ptr) -> (boolean)]] [flags single-valued pure unrestricted mifoldable discard])
  ($integer-40? [sig [(ptr) -> (boolean)]] [flags single-valued pure unrestricted mifoldable discard])
  ($integer-48? [sig [(ptr) -> (boolean)]] [flags single-valued pure unrestricted mifoldable discard])
  ($integer-56? [sig [(ptr) -> (boolean)]] [flags single-valued pure unrestricted mifoldable discard])
  ($integer-64? [sig [(ptr) -> (boolean)]] [flags single-valued pure unrestricted mifoldable discard])
  ($integer-8? [sig [(ptr) -> (boolean)]] [flags single-valued pure unrestricted mifoldable discard])
